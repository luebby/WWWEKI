...
Nun könnte man einen genialen Einfall haben: Man teilt das Wohnzimmer einfach auf.
...
question("Erhöht diese Raumteilung den Preis der Immobilie im Mittel um $22573$?",
         answer("Ja"),
...
**Grundidee**: Um die Änderung von $\color{blue}{y}$ zu schätzen, wenn $\color{green}{x}$ verändert wird, sollten nicht-kausale Pfade (*Gabeln*) unterbrochen werden, kausale Pfade(*Ketten*) aber nicht. Gleichzeitig sollten keine nicht-kausalen Pfade (*umgedrehte Gabeln*) aufgemacht werden. 
