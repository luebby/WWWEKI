...
ranksep = 0.7;
 ...
 node [shape = circle fontcolor = black fontname = Poppins fontsize = 6 style = filled]
   A [label = 'Kaffeekonsum' fillcolor = '#0F710B']
   B [label = '  Fehlgeburt  ' fillcolor = '#0033cc']
   C [label = '    Übelkeit    ']
   U [label = '         U        ']
 edge [minlen = 2]
  A -> B      [penwidth = .2]
...
rankdir = LR;
 ...
 node [shape = circle fontcolor = black fontname = Poppins fontsize = 11 style = filled]
   ...
   B [label = '  Art der Gesellschaft  ' fillcolor = '#0F710B']
   C [label = '    Bis 5 Überleben    ']
   D [label = '    Bis 70 Überleben    ' fillcolor = '#0033cc']
 edge [minlen = 2]
   {A; B} -> {C; D} [penwidth = .5]
        C -> D      [penwidth = .5]
}
