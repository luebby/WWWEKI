...
Wir wissen, was passiert ist, nachdem wir links abgebogen. Wir wollen wissen, was passiert wäre, wenn wir rechts abgebogen wären &ndash; mit dem Wissen des Ergebnisses nach der Abbiegung nach links.
...
**Hinweis**: In Wirklichkeit gibt es natürlich viele weitere Faktoren, die hier eine Rolle spielen, dieses Beispiel ist eine *Karikatur* der Wirklichkeit mit dem Ziel das Konzept zu illustrieren. 
Das Beispiel hat nicht den Anspruch die Wirklichkeit zu beschreiben!
...
<red>&#9888;</red> Dass die Bestimmung des Counterfactuals in diesem karikierten Beispiel so einfach war, liegt daran, dass wir nur zwei Variablen und für diese auch noch ein lineares Modell angenommen haben.
