...
Würden wir den individuelle kausale Effekt $\color{orange}{\Delta}_i$ kennen (Variable `effekt` in unserem `R` Beispiel), könnten wir u.a. den durchschnittlichen kausalen Effekt berechnen, indem wir alle $i$ individuellen kausalen Effekte addieren und diese Summe ($\sum$) durch die Anzahl der Beobachtungen ($n$) dividieren: 
