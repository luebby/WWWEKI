...
In den Beispielen haben Sie gesehen, dass sich beobachtete Zusammenhängen deutlich von den wahren kausalen Zusammenhängen unterscheiden können &ndash; sogar so weit, dass insgesamt beispielsweise ein negativer Zusammenhang beobachtet wird, während in einer adjustierten Betrachtung ein postiver Zusammenhang vorliegt. Ein Beispiel für das **Simpson-Paradoxon**.
