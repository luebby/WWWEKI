...
In der Praxis kennen wir zwar nicht beide Potential Outcomes, aber wir wissen, wer an der Schulung teilgenommen hat und wer nicht. Daraus ergibt sich, welches der beiden Potential Outcomes beobachtet ist und welches uns fehlt (das Counterfactual). 

In der Praxis sähe unsere fiktive Gehaltstabelle also anders aus -- fehlende Werte würden in `R` als `NA` (engl.: not available, nicht verfügbar) dargestellt werden.
