...
Ob die Adjustierung für eine Menge an Variablen (für ein *Adjustment Set*) hinreichend ist, um einen kausalen Effekt von Interesse zu identifizieren, kann mithilfe des sogenannten *Back-Door Criterion* (Hintertür-Kriterium) bestimmt werden.
