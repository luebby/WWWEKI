...
Die Unterscheidung zwischen Ursache und Wirkung erfolgt hier aus inhaltlichen, theoretischen Überlegungen. Dabei können z.B. zeitliche Überlegungen helfen (die Ursache erfolgt vor der Wirkung), aber insbesondere auch Experimente (siehe Modul 8). Beides ist auch Bestandteil der [Bradford-Hill-Kriterien](https://journals.sagepub.com/doi/pdf/10.1177/003591576505800503):

- Stärke: Eine Beziehung ist eher kausal, wenn der Zusammenhang groß und statistisch signifikant ist. 
...
- Gradient: Eine Beziehung ist eher kausal, wenn eine größerer Wert in der Ursache zu einem größeren Wert in der Wirkung führt. 
