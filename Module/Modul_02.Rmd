...
ux <- function() sample(c("Ja", "Nein"),1)
fy <- function(x) ifelse(x == "Ja", sample(c("Ja", "Nein"), 1, prob = c(0.9,0.1)), sample(c("Ja", "Nein"), 1, prob = c(0.4,0.6)))
...
Manche glauben ja, dass Kinder auf Ihre Eltern hören. Das schöne an abstrakten, gedanklichen Welten ist, dass das dort realisiert werden kann. Variablen (Knoten) auf die eine Pfeilspitze zeigt werden **Kinder** der Variablen genannt von denen die Pfeile ausgehen. Diese Variablen werden entsprechend **Eltern** genannt: $\text{Eltern} \rightarrow \text{Kinder}$. Im Beispiel von oben ist <blue> Schmerzrückgang </blue> ein Kind von <green> Tabletteneinnahme </green> - und dementsprechend <green> Tabletteneinnahme </green> Eltern von <blue> Schmerzrückgang </blue>.
...
question("Was passiert wenn wir **intervenieren**, d.h., die Tabletteneinnahme ist nicht zufällig Ja oder Nein, sondern wir legen fest, dass die Tablette eingenommen wird?",
         answer("Die Anzahl der Menschen mit Schmerzreduktion ändert sich nicht.", message = "Druch die Intervention gilt nicht mehr $P(\\color{green}{\\text{Tabletteneinnahme}})=0.5$ sondern $P(\\color{green}{\\text{Tabletteneinnahme}})=1$. Und da die Tablette in $90\\%$ der Fälle hilft erwarten wir im Mittelwert eine Verbesserung bei $100 \\times 0.9 = 90$ von $100$ Personen."),
         answer("Die Anzahl der Menschen mit Schmerzreduktion erhöht sich.", correct = TRUE, message = "Druch die Intervention gilt nicht mehr $P(\\color{green}{\\text{Tabletteneinnahme}})=0.5$ sondern $P(\\color{green}{\\text{Tabletteneinnahme}})=1$. Und da die Tablette in $90\\%$ der Fälle hilft erwarten wir im Mittelwert eine Verbesserung bei $100 \\times 0.9 = 90$ von $100$ Personen."),
         answer("Die Anzahl der Menschen mit Schmerzreduktion reduzuiert sich.", message = "Druch die Intervention gilt nicht mehr $P(\\color{green}{\\text{Tabletteneinnahme}})=0.5$ sondern $P(\\color{green}{\\text{Tabletteneinnahme}})=1$. Und da die Tablette in $90\\%$ der Fälle hilft erwarten wir im Mittelwert eine Verbesserung bei $100 \\times 0.9 = 90$ von $100$ Personen."),
		correct = "Schön!",
		incorrect = "Leider falsch."
         )
```
