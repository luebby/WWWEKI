...
- <purple> Gehalt </purple> mit <olive> Schulung <olive>
 
- <purple> Gehalt </purple> ohne <olive> Schulung <olive>
...
Damit ergibt sich der **individuelle kausale Effekt** $\color{blue}{\Delta}_i$ (gr. *Delta*) der Teilnahme als:
...
Der naive Vergleich der Mittelwerte überschätzt hier den wahren durchschnittlichen Effekt. Dies liegt daran, dass in diesem fiktiven Beispiel Personen mit einem höherem Gehaltsinteresse eher an der Schulung teilgenommen haben als die mit einem niedrigeren Interesse. Die Teilnehmer:innen hätten aber, aufgrund Ihres Gehaltsinteresses so oder so, also unabhängig von der Schulung, ein höheres Gehalt erwartet.
