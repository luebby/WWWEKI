...
question("Ist diese Stichprobe *repräsentativ* -- können gültige Schlüsse über die Population getroffen werden?",
         answer("Ja"),
...
question("Lassen alleine die Daten der Schlagzeile den Schluss zu, dass Stillen zu mit einer Reduktion des Allergierisikos korreliert ist?",
         answer("Ja"),
         answer("Nein", correct = TRUE, message = message),
		allow_retry = TRUE,
		correct = random_praise(),
