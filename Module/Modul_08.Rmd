...
question("Lassen die Daten der Beobachtungsstudie den Schluss zu, dass der durchschnittliche kausale Effekt von Stillen auf die Wahrscheinlichkeit Übergewicht zu entwickeln bei $0.14$ liegt?",
         answer("Ja"),
         answer("Nein", correct = TRUE, message = message),
		allow_retry = TRUE,
		correct = random_praise(),
