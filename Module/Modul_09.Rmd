...
Wir wissen was passiert ist, nachdem wir links abgebogen sind &#129042; wir wollen wissen was passiert wäre, wenn wir rechts abgebogen wären &ndash; mit dem Wissen des Ergebnisses nach der Abbiegung nach links.
...
> Sie lernen für eine Klausur, z. B. 10 Stunden. Sie erreichen in der Klausur eine gute Note, sagen wir mit 50 Punkten.
...
<red>&#9888;</red> Dass die Bestimmung des Counterfactuals in diesem karrikierten Beispiel so einfach war, liegt daran, dass wir nur zwei Variablen und für diese auch noch ein lineares Modell angenommen haben.

```{r vorhersage, echo=FALSE}
question("Wie lautet das Counterfactual $y$, wenn $x=10$ ist, sowie $x'=20$ und $y'=30$ beobachtet wurden?",
         answer("$0$"),
