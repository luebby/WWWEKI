...
:::{.box}
Um den (totalen) kausalen Effekt von $X$ auf $Y$ in einer umgedrehten Gabel $$X \leftarrow Z \leftarrow Y$$ zu bestimmen, sollte ein Collider $Z$ nicht berücksichtigt werden. (Und auch keine Nachfahren von $Z$.)
