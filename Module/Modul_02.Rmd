...
question("Welche Variable ist bzw. welche Variablen sind Eltern von *Nass* (X4)?",
         ...
         answer("Jahreszeit.", message = "Nass hängt ab von Wassersprenger und Regen."),
         answer("Wassersprenger und Regen.", correct = TRUE,  message = "Nass hängt ab von Wassersprenger und Regen."),
         answer("Rutschig.", message = "Nass hängt ab von Wassersprenger und Regen."),
		correct = "Klasse!",
		incorrect = "Leider falsch."
         )
```
...
question("Welche Variable ist bzw. welche Variablen sind Kinder von *Nass* (X4)?",
         ...
         answer("Jahreszeit.", message = "Rutschig hängt ab von Nass."),
         answer("Wassersprenger und Regen.", message = "Rutschig hängt ab von Nass."),
         answer("Rutschig.", correct = TRUE , message = "Rutschig hängt ab von Nass."),
		correct = "Schön!",
		incorrect = "Leider falsch."
         )
```
...
Dabei sind $U_{\color{green}{X}}$ und $U_{\color{blue}{Y}}$ unbekannte Ursachen oder Fehler von $\color{green}{X}$ und $\color{blue}{Y}$, und $f_{\color{blue}{Y}}(\color{green}{X},U_{\color{blue}{Y}})$ die Funktion, der Mechanismus wie $\color{blue}{Y}$ auf Basis von ´ zu seinem Wert kommt. 
