...
- dass wir Zusammenhänge sehen, die wir ungewollt erzeugen.
...
Wieder stark vereinfacht: Fürs Daten seien Nettigkeit und Aussehen wichtig. 
...
message <- "Wenn es kein Glück oder Pech ($U_Z$) war, dann ist die nicht-nette Person eher hübsch. Es gibt ja einen Grund dafür, dass Sie sie daten. Wenn es nicht die Nettigkeit ist, dann das Aussehen."
...
Die Variable sollte z.B. nicht als erklärende Variable in ein lineares Modell aufgenommen werden.
::: 
