...
Wenn Sie vor der Entscheidung stehen: *Nehme ich an der Schulung teil?* gibt es für Ihr Gehalt zwei **potentielle Ergebnisse** (engl.: Potential Outcomes):
...
$$\color{purple}{Y}^{\color{olive}{X_=1}}_i - \color{purple}{Y}^{\color{olive}{X=0}}_i$$
...
Schauen wir uns einmal eine fiktive Gehaltstabelle von Potential Outcomes:
...
## Das fundamentales Problem der kausalen Inferenz
