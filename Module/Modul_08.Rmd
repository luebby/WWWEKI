...
```{r graph1, echo=FALSE}
message <- "Beim Teilgraph Kauf von Bio-Lebensmittel $\\leftarrow$ Geschlecht $\\rightarrow$ Lebenserwartung handelt es sich um eine Gabel."
question("Welche Rolle spielt hier das Geschlecht zwischen Kauf von Bio-Lebensmitteln und Lebenserwartung?",
         answer("Mediator"),
...
Der Kauf von Bio-Lebensmitteln ist farblich durch <purple>Ja (lila)</purple> und <orange>Nein (orange)</orange> gekennzeichnet:
...
```{r stipro, echo=FALSE}
message <- "Frauen sind in der Stichprobe überrepräsentiert."
...
Dadurch, dass hier Frauen eine höhere Wahrscheinlichkeit haben, Teil der Stichprobe zu sein, und häufiger Bio-Lebensmittel kaufen, überschätze ich in Folge mit meiner Stichprobe den Anteil der Käufer:innen von Bio-Lebensmitteln.
...
```{r ki, echo=FALSE}
message <- "Geschlecht ist hier ein Confounder und liegt auf einen nicht-kausalen Pfad von Bio-Lebensmittel zu Lebenserwartung und verzerrt somit die Schätzung des kausalen Effekts."
...
Während in der fiktiven Studie dieser Anteil, wie in der Schlagzeile berichtet, bei <purple>Bio-Lebensmittel</purple>-Kund:innen bei $\color{purple}{`r plangbio`}$ liegt, liegt er bei <orange>Nicht-Bio-Lebensmittel</orange>-Kund:innen bei $\color{orange}{`r plangkeinbio`}$.
...
Aber: Frauen kaufen auch häufiger <purple>Bio</purple> als Männer &ndash; und haben im Mittel eine höhere Lebenserwartung als Männer
